...
const branze: Branża[] = [
  { key: "mechanik", label: "Mechanik / Warsztat", icon: <FaWrench size={36} />, href: "/branze/mechanik", heroBg: "/backgroundmechanic.jpg" },
  { key: "fotografia", label: "Fotografowie", icon: <FaCamera size={28} />, href: "/branze/fotografia", heroBg: "/backgroundphotography.webp" },
  { key: "kosmetyka", label: "Kosmetyczki / SPA", icon: <FaSprayCan size={28} /> },
  { key: "budowlanka", label: "Rzemieślnicy / Budowlanka", icon: <FaHammer size={28} /> },
  { key: "ogrodnictwo", label: "Ogrodnicy", icon: <FaLeaf size={28} /> },
  { key: "fitness", label: "Fitness / Siłownie", icon: <FaDumbbell size={28} /> },
  { key: "transport", label: "Transport / Przewozy", icon: <FaBus size={28} /> },
  { key: "autodetailing", label: "Auto Detailing / Car Detailing", icon: <FaCar size={30} />, href: "/branze/autodetailing" },
  ...
  { key: "nowe", label: "Nowe branże w przygotowaniu", icon: <FaPlus size={28} />, disabled: true },
];
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 lg:py-10">
          ...
          b.href ? (
            <Link
              ...
              className={`
                ...
                ${
                  ["mechanik", "fotografia", "autodetailing"].includes(b.key)
      ...
      <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mt-10 sm:mt-12">
        <div className="flex items-center gap-2">
          ...
          <span className="text-gray-700 text-xs sm:text-sm">Aktywna branża / polecana</span>
        </div>

        <div className="flex items-center gap-2">
          <div className="w-4 h-4 sm:w-5 sm:h-5 bg-blue-50 rounded-full border border-blue-400 opacity-70 animate-pulse"></div>
          <span className="text-gray-500 text-xs sm:text-sm">Nowe branże w przygotowaniu</span>
        </div>

        <div className="flex items-center gap-2">
          <div className="w-4 h-4 sm:w-5 sm:h-5 bg-gray-100 rounded-full border border-gray-300 opacity-50"></div>
          <span className="text-gray-400 text-xs sm:text-sm">Branża nieaktywna / w przygotowaniu</span>
        </div>
      </div>

      <p className="text-center text-gray-500 mt-4 sm:mt-6 max-w-3xl mx-auto text-sm sm:text-base leading-relaxed">
        Kliknij w branżę, aby zobaczyć dedykowane strony i oferty. Kolory kafli pokazują status dostępności danej branży.
      </p>
    </div>
  );
}
