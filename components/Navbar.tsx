  ...
  return (
    <nav className={`px-1 bg-white ${isSticky ? "sticky top-0 z-50 shadow-lg" : ""}`}>
      <div className="container mx-auto flex items-center justify-between flex-wrap">
        ...
        <div
          className={`${isMenuOpen ? "block" : "hidden"} w-full lg:flex lg:items-center lg:w-auto lg:justify-end`}
        >
                ...
                {data.menuItems.edges.map((edge : any) => (
                  ...
                  >
                    <Link href={edge.node.path || "/"} passHref>
                      <div
                        onClick={closeMenu}
                        className="cursor-pointer text-lg text-zinc-700 font-sans lg:px-1 py-1 lg:py-0 flex items-center hover:text-[#6082e2] transition duration-300"
                      >
          ...
          <div className="mt-2 lg:mt-0 lg:ml-4">
            <Link
              ...
              className="flex items-center bg-customColor text-white px-3 py-2 rounded-lg hover:bg-[#041a89] transition duration-300"
            >
