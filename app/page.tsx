...
export default function Home() {
  ...
  >      <div className="lg:w-7/12 lg:pr-8 mt-27 md:mt-28 xl:mt-32 lg:order-2">
        <h1 className="text-customColor text-5xl xl:text-7xl font-bold mb-4 text-center">Klaudiusz Adamaszek</h1>
        <h2 className='text-gColor font-bold text-2xl xl:text-4xl'>Web Developer</h2>
