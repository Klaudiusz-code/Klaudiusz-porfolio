...
const Icons = {
  Layout: () => <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>,
...
const services = [
  {
    ...
    description: "Buduję strony i sklepy, które są przejrzyste dla klienta i łatwe w obsłudze dla Ciebie. Dobre techniczne podstawy to podstawa zaufania.",
    features: ["Stabilne działanie", "Łatwy panel edycji", "Szybkość działania"]
  },
  {
    title: "Widoczność",
    subtitle: "Być tam, gdzie szukają.",
    description: "Dbam o techniczną poprawność Twojej strony w Google. To gwarantuje, że Twoja firma jest widoczna dla klientów z Twojej okolicy.",
    features: ["Google Maps", "Podstawy techniczne SEO", "Dostępność mobilna"]
  },
  {
    title: "Stała Wsparcie",
    subtitle: "Odpowiadam za stabilność.",
    description: "Strona wymaga regularnej uwagi. Prowadzę aktualizacje, dbam o bezpieczeństwo i zajmuję się bieżącą obsługą – od edycji tekstów po dodawanie zdjęć.",
    features: ["Edycja treści", "Aktualizacja zdjęć", "Serwis i bezpieczeństwo"]
  }
];
...
const ServicesSection = () => {
  return (
    <section className="py-32 bg-white text-slate-800 overflow-hidden relative">
      ...
      {/* TŁO */}      <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-blue-500/5 rounded-full blur-3xl translate-y-1/3 translate-x-1/3 pointer-events-none" />
        ...
        <div className="max-w-4xl mx-auto text-center mb-24">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <p className="text-lg text-slate-600 leading-relaxed font-medium">
              Nazywam się <strong>Klaudiusz</strong>. Jestem programistą i tworzę strony internetowe oraz sklepy. Rozumiem, że nie chcesz tracić czasu na techniczne problemy.
            </p>
            <p className="text-lg text-slate-500 leading-relaxed font-light">
              Dlatego dbam o stabilność Twojej strony i jestem bezpośrednim kontaktem – nie musisz przechodzić przez dział obsługi klienta. Moim celem jest technika, która działa i wspiera Twój biznes.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          ...
          <article className="group bg-white rounded-3xl p-10 border border-slate-100 shadow-lg shadow-slate-200/50 hover:shadow-2xl hover:shadow-blue-900/10 hover:-translate-y-1 transition-all duration-500 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-3 tracking-tight">{services[0].title}</h3>
              <p className="text-blue-600 font-bold text-xs uppercase tracking-widest mb-4">{services[0].subtitle}</p>
          ...
          <article className="group bg-white rounded-3xl p-10 border border-slate-100 shadow-lg shadow-slate-200/50 hover:shadow-2xl hover:shadow-blue-900/10 hover:-translate-y-1 transition-all duration-500 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-3 tracking-tight">{services[1].title}</h3>
              <p className="text-blue-600 font-bold text-xs uppercase tracking-widest mb-4">{services[1].subtitle}</p>
              <p className="text-slate-500 leading-relaxed mb-8 text-sm">
          ...
          <article className="group md:col-span-2 bg-gradient-to-br from-blue-900 to-slate-900 text-white rounded-[2rem] p-10 md:p-14 relative overflow-hidden shadow-2xl shadow-blue-900/20 border border-blue-800/50">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <h3 className="text-3xl md:text-5xl font-bold text-white mb-4 tracking-tight">{services[2].title}</h3>
                <p className="text-blue-200 font-bold text-xs uppercase tracking-widest mb-8">{services[2].subtitle}</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-3xl p-10 backdrop-blur-sm relative">
                ...
                <p className="text-sm font-bold uppercase tracking-widest text-blue-300 mb-8">W ramach opieki:</p>
                <ul className="space-y-5">
                  {services[2].features.map((f, i) => (
                    <li key={i} className="flex items-center gap-4 text-white text-lg font-medium">
                      <span className="text-blue-400 bg-blue-900/50 rounded-full p-1"><Icons.Check /></span>
                      {f}
                    </li>
                  ))}
                </ul>
