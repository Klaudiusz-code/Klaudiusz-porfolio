    ...
    <>
      ...
      <div className="cnt mx-auto">
        ...
        >
          ...
          <p className="text-[#e7e7e7] leading-8 mt-1 mb-6 font-sans font-[400] text-[1rem] md:text-[1.1rem] lg:text-[1.2rem] w-full md:max-w-[80%] lg:max-w-[70%] tracking-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-14 w-full gap-x-6">
            {ProjectsData.map((project, index) => (
              <div key={index} className="flex flex-row mb-4">
                <div className="border border-customColor  rounded-md w-full min-h-[350px] flex items-center justify-center">
